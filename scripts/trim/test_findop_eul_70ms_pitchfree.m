...
evalin('base', 'render_enable = false; run(''Init_Main.m''); use_avl_aero = false;');
...
opspec.Inputs(7).u = deg2rad(-15.0);
...
fprintf('\nfindop pitch-free result for %s\n', model);
...
assignin('base', 'findop_eul_70_pitchfree_result', op);
assignin('base', 'findop_eul_70_pitchfree_report', opreport);
