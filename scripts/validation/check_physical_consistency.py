...
This script does not require MATLAB. It inspects Init_Main.m and selected
...
from scripts.common.evtol_model_parser import parse_init_main, compute_mass_properties
...
def main():
    ...
    parsed = parse_init_main(root / "Init_Main.m")
