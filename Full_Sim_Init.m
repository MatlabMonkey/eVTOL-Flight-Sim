% Full_Sim_Init.m
% Canonical initialization script for the eVTOL_Simulation workflow.
%
...
wingPolar = struct();
tailPolar = struct();
polar_data_file = fullfile(repo_root, 'scripts', 'avl', 'generated', 'final_airfoil_polar_tables.mat');
if exist(polar_data_file, 'file') == 2
    ...
    warning('Full_Sim_Init:MissingPolarTables', ...
...
controller_id = 0; % 0=hold trim, 1=legacy LQR hold, 2=trim-point LQR, 3=tracking LQR, 4=scheduled path LQR
controller_state_ref = zeros(12, 20); % first column/page for trim-point controllers, full schedule for controller_id=4
