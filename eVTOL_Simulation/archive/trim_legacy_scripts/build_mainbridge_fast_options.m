function options = build_mainbridge_fast_options(root_dir)
%BUILD_MAINBRIDGE_FAST_OPTIONS Focused fast bridge search for 30-40 m/s.
% This is the main upper-middle bridge pass. It targets the 30-40 m/s gap
% with flatter, lower front-collective guide centers and moderate rear
% collective centers, using the latest lower-mid, left-bridge, and
% upper-mid results as anchors.
...
options.reference_knot_tilt_deg = [0 30 45 55 62 67 68 70 72.5 75 78 81];

options.front_guide_knot_vinf_mps = [0 5 10 15 20 25 27.5 30 32.5 35 37.5 40];
options.front_guide_knot_rpm = [1865.76 1988 2104 2180 2235 2225 2210 2000 1850 1700 1550 1450];

options.rear_guide_knot_vinf_mps = [0 5 10 15 20 25 27.5 30 32.5 35 37.5 40];
options.rear_guide_knot_rpm = [1756.38 1665 1517 1380 1070 780 620 950 900 850 800 750];
end
