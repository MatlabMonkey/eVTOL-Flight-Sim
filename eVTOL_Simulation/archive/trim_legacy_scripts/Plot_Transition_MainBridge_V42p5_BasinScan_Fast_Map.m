% Plot_Transition_MainBridge_V42p5_BasinScan_Fast_Map.m
% Plot the V=42.5 basin scan over the full transition map.
...
transitionMidbandGuideGridPlotPlanOptions = build_mainbridge_v42p5_basinscan_fast_options(root_dir);
