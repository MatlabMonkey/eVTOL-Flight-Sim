% Build_Controller_From_TrimPoint_Longitudinal_LQR.m
% Conservative longitudinal-only trim-point LQR entrypoint.
%
% Usage:
%   Init_EVTOL_Main
%   trimCase = <any trim case that produces an exact trim>
%   Trim_EVTOL_Main
%   Build_Controller_From_TrimPoint_Longitudinal_LQR
%
...
controllerData = build_trim_point_longitudinal_lqr_controller(trimResult);
