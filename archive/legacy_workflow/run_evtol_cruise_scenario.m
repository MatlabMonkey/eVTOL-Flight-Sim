...
cmds.front_cmd   = [t, U_trim_full(7) * ones(N, 1)];
cmds.rear_cmd    = [t, U_trim_full(8) * ones(N, 1)];
cmds.tilt_cmd    = [t, repmat(U_trim_full(5:6).', N, 1)];
cmds.motor_cmd   = [t, repmat(U_trim_full(1:4).', N, 1)];
