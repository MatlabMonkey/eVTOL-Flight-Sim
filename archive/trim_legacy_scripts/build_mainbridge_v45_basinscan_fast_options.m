function options = build_mainbridge_v45_basinscan_fast_options(root_dir)
%BUILD_MAINBRIDGE_V45_BASINSCAN_FAST_OPTIONS
% Single-airspeed basin scan at V=45 m/s, centered between the new
% 42.5/72.5 exact and the existing rear-on 45/75 borderline.
...
options.reference_knot_vinf_mps = [0 10 20 30 35 37.5 40 42.5 45 47.5];
options.reference_knot_tilt_deg = [0 45 62 67.5 65 67.5 67.5 72.5 75 77.5];

options.front_guide_knot_vinf_mps = [0 10 20 30 35 37.5 40 42.5 45 47.5];
options.front_guide_knot_rpm = [1865.76 2104 2235 2050 1900 1889 1665 1641 1300 1000];

options.rear_guide_knot_vinf_mps = [0 10 20 30 35 37.5 40 42.5 45 47.5];
options.rear_guide_knot_rpm = [1756.38 1517 1070 700 700 625 1485 1472 1150 950];
